...
#
# Vendor tree A37 untuk LineageOS 20 (Android 13, SDK 33) build 64-bit
# (TARGET_ARCH := arm64, TARGET_2ND_ARCH := arm).
#
# SUMBER TUNGGAL: cabang lineage-23-64bit repo ini. Fase 0 (13 Sep 2026)
# membuktikan itu cukup -- dari 52 berkas yang "hanya ada di lineage-18.1",
# 43 sebenarnya ADA di sini sebagai vendor/lib64/ dan 9 sisanya memang tidak
# pernah dikirim LOS 20. Berkas yang benar-benar absen: NOL.
#
# Pemilahan 326 entri sumber LOS 20 (A37-vendor.mk lineage-18.1: 320
# PRODUCT_COPY_FILES + 6 modul Android.bp):
#
#    71 pustaka dual-arch     dikirim di vendor/lib DAN vendor/lib64
#   159 pustaka 32-bit saja   129 di antaranya kamera/JPEG
#    43 pustaka 64-bit saja   IMS, RenderScript, varian EGL GLES, FLP
#    53 bukan pustaka         firmware, etc, bin, framework, app, priv-app
#
# 129 pustaka kamera tetap 32-bit karena Qualcomm tidak pernah merilis HAL
# kamera 64-bit untuk msm8916. Karena itu build ini WAJIB dual-arch, dan
# seluruh 13 biner vendor/bin tetap 32-bit.
#
# TIGA BERKAS WIDEVINE SENGAJA ADA DI POHON TAPI TIDAK DIPASANG:
#   vendor/bin/hw/android.hardware.drm@1.1-service.widevine
#   vendor/etc/init/android.hardware.drm@1.1-service.widevine.rc
#   vendor/lib/libwvhidl.so
# LOS 20 belum memasang Widevine sama sekali (nol sebutan di device.mk).
# Pola yang sama dipakai cabang lineage-18.1, yang juga membawa blob Widevine
# tanpa memasangnya. Menghidupkannya adalah pekerjaan T-A4 PLAN-64BIT sec.6,
# bukan bagian Fase 1.
#
...
# Menambahkan barisnya di sini TIDAK berpengaruh apa pun; kekeliruan itu
# sudah pernah terjadi di proyek 23.2 dan baru ketahuan saat memeriksa isi
# image, bukan saat build.
...
PRODUCT_COPY_FILES += \
    ...
    vendor/oppo/A37/proprietary/vendor/lib/libmmcamera_tuning.so:$(TARGET_COPY_OUT_VENDOR)/lib/libmmcamera_tuning.so \
